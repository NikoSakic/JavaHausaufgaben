 ...
 * 
 * @author Niko Sakic
 * Traegt das Spiel mit verschiedenen Blaettern aus
 * 
 */
public class Pokerspiel {
	
	// Main fuhert die Spiele aus
	...
	/**
	 * Die Methode prueft fuer zwei Blaetter, welches gewonnt hat, und gibt das Ergebnis aus.
	 * @param b1 Blatt 1
	 * @param b2 Blatt 2
